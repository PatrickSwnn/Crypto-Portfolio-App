...
extension PreviewProvider {
    var coinPreview : DeveloperPreview {
        return .shared
    }
}
...
final class DeveloperPreview {
    ...
    let stat1 = StatsModel(title: "Title", value: "100")
    let stat2 = StatsModel(title: "Value", value: "200")
    let stat3 = StatsModel(title: "Title", value: "300", percentChange: 12.32)
    let stat4 = StatsModel(title: "Value", value: "400", percentChange: -13.22)
